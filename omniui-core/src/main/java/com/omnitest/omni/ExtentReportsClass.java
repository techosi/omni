...
public class ExtentReportsClass {
	...
	public void startReport() {
		extent = new ExtentReports(
				System.getProperty("user.dir") + "/test-output/reports/" + "report" + new Date().toString() + ".html");
		logger = extent.startTest("Test Started");
		extent.addSystemInfo("Host Name", "OMNI REPORT").addSystemInfo("Environment", "Automation Testing")
